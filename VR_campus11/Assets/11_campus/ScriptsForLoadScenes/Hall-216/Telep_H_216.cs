    ...
    {  //Создадим диалог
        ...
        {  // если visible = true
            ...
            {  // если нажать "Я хочу войти"
                ...
                SceneManager.LoadScene("216", LoadSceneMode.Additive); // и загружается сцена 2 (название сцены, у вас оно может быть другое)
                if (SceneManager.GetSceneByName("216").isLoaded)
                {
