...
public class GameManagers : MonoBehaviour {
   ...
   //          StaticDataForTestGame staticDataForTest;
    ...
    void LoadQuestions()
    {
        Object[] objs = Resources.LoadAll(StaticDataForTestGame.pathToQuestion, typeof(Question));
    ...
    {
        if(StaticDataForTestGame.sceneNameIfExit != null) 
